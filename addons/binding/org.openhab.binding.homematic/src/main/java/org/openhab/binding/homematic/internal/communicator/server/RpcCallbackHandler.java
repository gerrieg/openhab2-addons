 ...
 */
public class RpcCallbackHandler implements Runnable {
    ...
    public RpcCallbackHandler(Socket socket, RpcEventListener listener, String encoding) {
        this.socket = socket;
    ...
    public void run() {
        try {
            ...
            byte[] returnValue = handleMethodCall(message.getMethodName(), message.getMessageData());
            if (returnValue != null) {
